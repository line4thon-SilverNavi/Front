...
export default function Certify() {
  ...
  return (
    ...
    >
      <Wrapper>
        <Title>장기요양인증서 촬영</Title>
        <Caption>인증서를 촬영하거나 업로드하세요</Caption>

        <MyGrade>
          <TitleContainer>
            <img
              src="/img/mypage/camera.png"
              style={{ width: "20px", height: "20px" }}
            />
            촬영 가이드
          </TitleContainer>
